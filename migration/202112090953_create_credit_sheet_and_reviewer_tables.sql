CREATE TABLE `p2p_loan`.`credit_sheet` (
   ...
   `certification_list` JSON NOT NULL DEFAULT '' COMMENT '核准額度當下的已通過認證項目編號',
   `relation` JSON NOT NULL DEFAULT '' COMMENT '關係戶資料',
   ...
   `note` VARCHAR(300) NOT NULL COMMENT DEFAULT '' '其他說明',
