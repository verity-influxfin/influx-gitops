<template>
    <div>
        ...
        <div class="頂部板岩">
            <div class="背景">
                <img class="圖片" src="/images/sshot-1907.png">
            </div>
            <div class="遮罩">
                <div class="標題">查看案件</div>
                <div class="內容">
                    獨立債權，多元投資<br>
                    超高報酬，穩定收入
                </div>
        ...
        <div class="案件區塊">
            ...
            <alesis-section>
                ...
                <div class="包裹容器">
                    ...
                    <div class="排序條件">
                        <a href="#!" class="項目 項目_啟用的">上架日</a>
                        <a href="#!" class="項目">金額</a>
                        <a href="#!" class="項目">期數</a>
                        <a href="#!" class="項目">年利率</a>
                        <a href="#!" class="項目">信評</a>
                        <div class="項目">
                            <div class="箭頭群組">
