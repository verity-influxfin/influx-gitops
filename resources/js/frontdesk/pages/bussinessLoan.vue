      ...
      questions: [
        {
          ...
          answer: `您好！非常抱歉造成您的困擾！
            因系統採取全自動化辨識，而有角度上微微的調整
            發現辨識上錯誤的話，須再麻煩您重新拍照上傳～謝謝您！
            如還有多次未能成功再麻煩聯絡我們客服
            我們會儘速與您聯繫`,
          active: false,
        },
        {
          question: '工作資料有哪些？',
          answer: `您好！目前的工作資料需提供的是『勞保異動明細』
            『勞保異動明細』申請方式可至「各縣市的勞動部申請」或「自然人憑證線上申請」
            申請完後的紙本資料做拍照上傳驗證的動作即可審核
          `,
          active: false,
        },
        {
          question: '財務訊息是哪些？',
          answer: `您好！目前的財務訊息需提供的是「近六個月往來存摺封面及內頁」
          幫我拍照上傳即可！`,
          active: false,
        },
        {
          ...
          answer: `您好！以下有兩種不同身份聯徵的申請方式
            ...
            郵局也有指定格式可以申請，並郵寄至普匯（台北市中山區松江路 111 號 11 樓之 1）
          `,
          active: false,
        },
        {
          question: '系統會通知我的保證人進行驗證嗎',
          answer: `您好！我們會根據您填寫的保證人資料，以簡訊及Email方式寄送通知
            因此在填寫保證人相關資料時，請幫我確認資料是否完整正確，謝謝您！
          `,
          active: false,
        },
        {
          question: '保證人如果反悔不願擔任，該怎麼處理',
          answer: `您好！請先聯絡普匯客服人員提出更改
            系統會先將您的案子退件，以便您重新修改，再進行申請
          `,
          active: false,
        },
        {
          question: '申請人，保證人資料都驗證完成，接下來該如何處理',
          answer: `您好！接下來會將您的案件資訊轉由銀行做最後核決，
            只需等待審核通過即可！
          `,
          active: false,
        },
        {
          ...
          answer: `您透過普匯APP申請的【微企e秒貸】案件進入銀行端後
            銀行會派專員與您聯繫進行對保動作，利率與實際核准額度將由銀行端與您接洽，在普匯APP上也會同步顯示出來
          `,
          active: false,
        },
        {
          question: '利率與核貸金額核定後，還能調整嗎',
          answer: `由銀行端核定的額度與利率即為本次申請的合約內容
            您可選擇是否需要動用本次條件的申貸，至於內容能否調整，可與銀行端與您接洽的窗口洽詢
          `,
          active: false,
        },
        {
          question: '一般企業融資沒還款會怎樣',
          answer: `因貸款方為銀行，若您忘記還款，請立即與放款銀行聯繫，處理後續逾期事宜，
            要逾期即會造成企業、負責人的信用瑕疵,為避免上述情況發生，請務必依約定準時還款。
          `,
          active: false,
        },
        {
          question: '這次申請過金額不夠用，還能再申請一筆這種普匯企業貸款嗎',
          answer: `可以的，除了固定申請一百萬額度的【微企e秒貸】，
            也可以在普匯申請信保專案、一般企業融資專案，解決您運營上的資金問題。
          `,
          active: false,
        }
      ],
