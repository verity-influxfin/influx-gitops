  ...
  <div class="bank-wrapper" id="bank-wrapper">
    ...
    <div class="form">
		<div class="event-form">
			...
			<div class="input-group">
			  <button class="btn send-btn scsbank-send-btn" @click="sendBankEvent">立即申請</button>
			</div>
		</div>
	</div>
	<div class="scsbank-content-bottom">
	</div>
  </div>
</template>
