  ...
  <div class="college-loan">
      ...
      <div class="block-content">
        ...
        <div class="row no-gutters feature-cards">
          ...
          >
            ...
            <ul class="feature-card-list">
              <li class="feature-card-item">
                「學習工具不能少」3C、筆電、手機… 通訊費，通通找普匯！
              </li>
              <li class="feature-card-item">
                「學生就是需要一台機車」不管上課、打工、郊遊、交朋友，都要騎上它，機車找普匯，準沒錯！
              </li>
            </ul>
          </feature-card>
          <feature-card
          ...
          >
            ...
            <ul class="feature-card-list">
              <li class="feature-card-item">
                「學費、書本費、雜費、生活費」樣樣都是費，善用科技普匯金融立馬貸給你。
              </li>
              <li class="feature-card-item">
                考研、學程式語言、第二專長、興趣進修，普匯通通願意滿足你！
              </li>
            </ul>
          </feature-card>
          <feature-card
          ...
          >
            ...
            <ul class="feature-card-list">
              <li class="feature-card-item">
                參加社團、社群活動，樣樣都要花錢，普匯隨時金援你！
              </li>
              <li class="feature-card-item">
                畢展、畢旅，不用跟家人伸手、不必麻煩別人，更不需要打工荒廢學業，普匯好朋友貸給你！
              </li>
            </ul>
          </feature-card>
        </div>
    ...
    <div class="apply-intro">
      <div class="block-content">
        ...
        <div class="row no-gutters apply-slogan">
          <img
    ...
    <div class="reason">
        ...
        <div class="row no-gutters reason-row">
          <div class="reason-intro col-md-auto col-12">
            ...
            <div class="reason-intro-list">
              <div class="reason-intro-item">全程使用APP，不跳轉，無人打擾</div>
              <div class="reason-intro-item">申辦免費、不核准免費</div>
              <div class="reason-intro-item">放款完全不受休假限制</div>
              <div class="reason-intro-item">核貸通過率超過90%</div>
      ...
      <div class="bottom-title">普匯•就是快</div>
    </div>
    <div class="case">
      <h1 class="h1">普匯最有溫度，最安全</h1>
      <h2 class="h2">
        <div>全國市占最高，幫助超過156所大學生</div>
        <div>已幫助超過數萬名學生，不論是生活急需、補習進修、</div>
        <div>購買3C、機車，都在找普匯！</div>
      </h2>
      <div class="block-content">
    ...
    <div class="product-info">
      <div class="row no-gutters" style="justify-content: center; height: 50px;">
        <span style="margin: auto 0; font-size: 14px; color: #023D64; font-weight: 700;">學生貸</span>
        <span class="ml-3" style="margin: auto 0; font-size: 12px; color: #023D64; opacity: 0.56; font-weight: 400;">•申貸金額：NT$ 3,000~150,000元</span>
        <span class="ml-3" style="margin: auto 0; font-size: 12px; color: #023D64; opacity: 0.56; font-weight: 400;">•利率：學生貸4%~16%</span>
        <span class="ml-3" style="margin: auto 0; font-size: 12px; color: #023D64; opacity: 0.56; font-weight: 400;">•期數：3~24期</span>
        <span class="ml-3" style="margin: auto 0; font-size: 12px; color: #023D64; opacity: 0.56; font-weight: 400;">•平台服務費：平台服務費最低500元，學生貸3%</span>
        <span class="ml-3" style="margin: auto 0; font-size: 12px; color: #023D64; opacity: 0.56; font-weight: 400;">•範例：貸款金額 NT$ 2 萬，貸款期間 2 年，貸款年利率 4%~16% (固定計息)，手續費為本金3%為600元，總費用年百分率約為：6.99%~19.17%。</span>
      </div>
    </div>
  </div>
</template>
    ...
    .reason-intro {
      ...
      &-item {
        ...
        &::before {
          ...
          flex: 0 0 85px;
          background-image: url('~images/collegeLoan/list.png');
