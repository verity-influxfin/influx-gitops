<template>
    <div>
        ...
        <div class="頂部板岩">
            <div class="背景">
                <img class="圖片" src="/images/sshot-2112.png">
            </div>
            <div class="遮罩">
                <div class="標題">
                    <div>普匯投資</div>
            ...
            <div class="展示區域">
                <img class="圖片" src="/images/直手機-14.png">
            </div>
        </div>
        <!-- 頂部板岩 -->
            ...
            <alesis-section>
                ...
                <div class="項目清單">
                    <div class="項目">
                        ...
                        <div class="特色列表">
                            <div class="特色">
                                <span class="顯著的">自選債權：</span>
                                優良債權　自由選擇
                            </div>
                            <div class="特色">
                                <span class="顯著的">智能投資：</span>
                                設定喜好　AI自動投標
                            </div>
                        </div>
                    </div>
                    <div class="項目">
                        <div class="標題">債權轉讓</div>
                        <div class="分隔線"></div>
                        <div class="特色列表">
                            <div class="特色 特色_置中的">
                                轉讓債權　立即變現
...
.債權種類 .項目清單 .項目 .特色列表 .特色.特色_置中的 {
    margin: 0 auto;
}

.債權種類 .項目清單 .項目 .特色列表 .特色 .顯著的 {
    font-weight: bolder;
    color      : #112e53;
}

.債權種類 .項目清單 .項目 .特色列表 .特色:not(:last-child) {
    margin-bottom: 1rem;
}
