  ...
  <div class="work-loan">
          ...
          <div class="feature-grid">
            <div class="card" data-aos="fade-up">
              <div class="card-body">
                <div class="card-cover">
                  <img
                    src="@/asset/images/workloan/feature-icon-1.png"
                    class="img-fluid mx-auto"
                  />
                </div>
                <div class="card-title">利率最低5%起</div>
            ...
            <div class="card" data-aos="fade-up">
              <div class="card-body">
                <div class="card-cover">
                  <img
                    src="@/asset/images/workloan/feature-icon-2.png"
                    class="img-fluid mx-auto"
                  />
                </div>
                <div class="card-title">絕無隱藏費用</div>
                <div class="card-divider"></div>
              </div>
            </div>
            <div class="card" data-aos="fade-up">
              <div class="card-body">
                <div class="card-cover">
                  <img
                    src="@/asset/images/workloan/feature-icon-3.png"
                    class="img-fluid mx-auto"
                  />
                </div>
                <div class="card-title">借款最長24期</div>
                <div class="card-divider"></div>
              </div>
            </div>
            <div class="card" data-aos="fade-up">
              <div class="card-body">
                <div class="card-cover">
                  <img
                    src="@/asset/images/workloan/feature-icon-4.png"
                    class="img-fluid mx-auto"
                  />
                </div>
                <div class="card-title">每期償還本息</div>
                <div class="card-divider"></div>
              </div>
            </div>
          </div>
        ...
        <div class="feature-user">
          <div class="card" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="card-body">
              <div class="portrait">
                <img
                  src="@/asset/images/workloan/feature-user-1.png"
                  class="img-fluid"
                />
              </div>
              <div class="portrait-info">一般企業員工</div>
              <div class="card-text">
                <div>• 不論公司規模，收入穩定皆適用！</div>
                <div>• 不管生活急用、資金周轉</div>
                <div>• 添購家居、車輛或小孩教養金</div>
              </div>
            </div>
          </div>
          <div class="card" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="card-body">
              <div class="portrait">
                <img
                  src="@/asset/images/workloan/feature-user-2.png"
                  class="img-fluid"
                />
              </div>
              <div class="portrait-info">金融機構員工</div>
              <div class="card-text">
                <div>• 證券、銀行、保險業皆適用</div>
                <div>• 投資理財，股票交割…</div>
                <div>• 快速取得資金，獲利加倍！</div>
              </div>
            </div>
          ...
          <div class="card" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="card-body">
              <div class="portrait">
                <img
                  src="@/asset/images/workloan/feature-user-3.png"
                  class="img-fluid"
                />
              </div>
              <div class="portrait-info">公家機關優質貸</div>
              <div class="card-text">
                <div>• 學校、醫院從業人員皆適用</div>
                <div>• 借款記錄不上聯徵，不影響信用</div>
                <div>• 全程免照會，無人化安全又隱私！</div>
              </div>
            </div>
          </div>
          <div class="card" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="card-body">
              <div class="portrait">
                <img
                  src="@/asset/images/workloan/feature-user-4.png"
                  class="img-fluid"
                />
              </div>
              <div class="portrait-info">上市櫃企業菁英貸</div>
              <div class="card-text">
                <div>• 快速審核、持證自拍</div>
                <div>• 免跑銀行、免受干擾</div>
                <div>• 台積電、日月光等大企業</div>
    ...
    <div class="product-info">
      <div class="row no-gutters" style="justify-content: center; height: 50px;">
        ...
        <span class="ml-3" style="margin: auto 0; font-size: 14px; color: #023D64; opacity: 0.56; font-weight: 400;">•平台服務費：平台服務費最低500元，上班族貸收取本金的4%</span>
      </div>
    </div>
  </div>
</template>
