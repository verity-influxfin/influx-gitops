<template>
    <div>
        ...
        <div class="row no-gutters" >
            <img src="@/asset/images/student-product-banner.png" style="width:100%" alt="">
        </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="步驟一">
                                <div class="左邊"></div>
                                <div class="中間">
                                    <img src="/images/alesis-collegeloan-step1.svg" class="圖片">
                                </div>
                                <div class="右邊">
                        ...
                        <div class="swiper-slide">
                            <div class="步驟二">
                                <div class="左邊"></div>
                                <div class="中間">
                                    <img src="/images/alesis-collegeloan-step2.svg" class="圖片">
                                </div>
                                <div class="右邊">
                        ...
                        <div class="swiper-slide">
                            <div class="步驟三">
                                <div class="左邊"></div>
                                <div class="中間">
                                    <img src="/images/alesis-collegeloan-step3.svg" class="圖片">
                                </div>
                                <div class="右邊">
                        ...
                        <div class="swiper-slide">
                            <div class="步驟四">
                                <div class="左邊"></div>
                                <div class="中間">
                                    <img src="/images/alesis-collegeloan-step4.svg" class="圖片">
                                </div>
                                <div class="右邊">
