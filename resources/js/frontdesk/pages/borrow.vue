    ...
    <div class="index-wrapper">
        ...
        <div class="alesis-features">
            <index-section header="簡單快速專區" multiline="全線上自動審核 無人打擾24小時立即到帳" :outlinedMulti="true">
                <div class="cards">
                <index-symcard image="/images/sshot-1635.png" header="企業融資" symbol="/images/alesis-companies.svg" description="支持中小企業，協助媒合百萬營運資金"></index-symcard>
                <index-symcard image="/images/sshot-1636.png" header="上班族貸" symbol="/images/alesis-work.svg" description="急需資金不再慌張，AI審核立即入帳"></index-symcard>
                <index-symcard image="/images/sshot-1638.png" header="學生貸" symbol="/images/alesis-student.svg" description="輕鬆分期不再煩腦，學生社群口碑最好"></index-symcard>
                <index-symcard image="/images/sshot-1637.png" header="車輛融資" symbol="/images/alesis-car.svg" description="敬請期待"></index-symcard>
                </div>
            </index-section>
        </div>
        <!-- / 簡單快速專區 -->
