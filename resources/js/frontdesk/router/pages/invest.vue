<template>
  <div class="invest-wrapper">
    ...
    <div class="compare-wrapper" data-aos="zoom-in">
      <img :src="'./Images/invest_web.png'" class="img-fluid desktop" />
    ...
    <div class="explanation-wrapper">
      ...
      <div class="explanation-img">
        <img class="hidden-desktop" :src="'./Images/how_to_invest_desktop.png'" />
        <img class="hidden-phone" :src="'./Images/how_to_invest_mobile.png'" />
      </div>
    </div>
    <join href="./Images/child_banner.jpg" :isShowInvest="true" subTitle="加入普匯完成你的財富目標吧！"></join>
...
export default {
  ...
  data: () => ({
    ...
    bannerData: {},
    investCategory: [
      "./Images/invest_puhey.png",
      "./Images/invest_fund.png",
      "./Images/invest_stock.png"
    ]
  }),
  computed: {
    video() {
