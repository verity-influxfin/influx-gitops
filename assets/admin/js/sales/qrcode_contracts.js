...
二、	合作期間
自民國    年    月    日起算一年，於本協議存續期間內，若雙方皆無以書面提供不續約之意思表示，則本協議自動續約一年。

三、	合作內容
(一)	甲方提供乙方實名會員可辨認乙方身份之二維條碼（下稱QR code），以供乙方分享其他使用者掃描註冊成為甲方之借款人新戶會員。經掃描甲方提供乙方之QR code成為甲方借款人會員之第三人，首次於甲方之借貸平台網頁「inFlux普匯金融科技(https://www.influxfin.com/)」或「普匯inFlux」APP完成首貸即取得貸款，發放業務獎金規則如下：
1.	個人融資產品：包括官網或手機APP公告之相關融資產品，包括學生貸、上班族貸或汽車融資，每筆核發獎金新台幣 %individual_reward% 元或該筆放款收取之服務手續費 %individual_platform_fee% % 提撥發放以資獎勵。
2.	企業融資產品：包括信保專案（銀行合作）、中小企業信貸、企業主速貸，每筆核發獎金新台幣 %enterprise_reward% 元或該筆放款收取之服務手續費 %enterprise_platform_fee% % 提撥發放以資獎勵。
3.	以上須扣除其他已發放之業務合作獎金。
4.	新戶定義：透過QR code完成會員註冊時起算半年內之第三人。
(二)	乙方應於甲方提供QR code前，註冊成為普匯會員，並完成相對應之實名認證。
(三)	業務獎金核發流程：
...
(四)	如甲方給付乙方獎金後，借款人有撤銷借款、借款後逾期或其他經甲方判定為借貸關係失效情事者，甲方得於下期獎金逕行扣除該筆獎金，乙方不得異議。
(五)	若本條一項之第三人有產生逾期之情形，其逾期人數佔總借貸人數之5％，則乙方應向甲方報告並檢討相關辦法，且甲方有權終止與乙方之合作。
(六)	乙方授權甲方，就乙方提供給甲方之相關資料製作勞務報酬單，相關資料內容包含但不限於身分證、生日、聯絡方式等等。
(七)	除經甲方書面同意外，乙方不得以網際網路或其他電子方式公開傳輸、散布本協議書，否則甲方得逕行終止本協議並扣除因此方式推廣之獎金。

四、	雙方權利義務
(一)	本協議並無創設雙方任何代理、合夥、經銷、投資、控制、從屬或關係企業關係之效力，乙方非甲方之代辦商，故乙方不得以甲方名義從事業務、利用甲方商標或以其他方式使大眾認知甲方與乙方於商業上有任何關聯性。
(二)	乙方承諾在本協議期間不得從事任何可能損害甲方聲譽的行為，不得以詐欺、不實廣告、違反誠實信用等行為履行本協議，若因乙方上述行為造成甲方直接、間接損害或名譽受損，乙方應賠償甲方因此所受之損害、損失、支出及法律費用。
(三)	除甲方明列之費用外，乙方不得藉由與甲方合作關係，向第三人索取額外費用，倘若乙方向第三人額外收取任何費用，概與甲方無涉。

五、	保密義務
(一)	乙方對於本協議之內容及因本協議所知悉或持有之甲方營業秘密（包括但不限於公司之技術、財務、策略或行銷規劃等資訊或其他乙方執行本協議所接觸或知悉甲方未對外公開之資訊等），應負保密義務。除依法令規定或依有權機關之要求而對相關主管機關提供者外，不得以任何方式提供或洩露予第三人，亦不得轉作其他目的使用。
(二)	於履行本協議必要之範圍內，乙方得將甲方之機密資料透露予其員工、代理人或顧問等知悉及處理，但乙方應與其員工、代理人或顧問簽訂與本條保密義務條款內容實質相同之保密契約，若該員工、代理人或顧問違反本條保密約定，視為乙方違反本條約定，乙方應同該員工、代理人或顧問對甲方負連帶賠償責任。
(三)	乙方或前項所示人員有違反本條約定者，甲方得向乙方請求50萬元之懲罰性違約金；如甲方因此受有損害者，並得另行請求因此所受之損害賠償（含合理律師費用）。
(四)	本條保密義務於本協議終止或解除後五年內仍有效。

六、	轉讓
甲、乙雙方在本協議中之權利及義務，除經他方書面同意外，不得轉讓予任何第三人。

七、	終止合作
(一)	協議任一方欲提前終止本協議，應於一個月前以書面通知他方。
(二)	甲方得在下述各款情況，逕行終止本協議，並請求乙方賠償所受損害；因第一款情形終止協議，甲方得不給予乙方獎金：
...
九、	管轄
雙方同意本協議以中華民國法律為準據法，關於本協議書如有任何爭議，雙方應依誠信原則協商解決，如有訴訟之必要，雙方同意以臺灣臺北地方法院為第一審管轄法院。
...
var app = new Vue({
  ...
  methods: {
    ...
    review_contract: function (apply_id) {
        let self = this;
