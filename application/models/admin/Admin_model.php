...
class Admin_model extends MY_Model
{
    ...
    public function get_data_by_id(int $admin_id)
    {
        ...
        $admin_data = $this->db
            ->select('a.id,a.name,a.email,a.group_id,a.permission_status,g.division,g.department,g.position')
            ->from('p2p_admin.admins a')
            ->join('p2p_admin.groups g', 'g.id=a.group_id')
            ->where('a.id', $admin_id)
            ->get()
    ...
    public function get_action_type($admin_id, $permission_model, $permission_submodel)
    {
        $this->db
        ...
        return $this->db->get()->first_row('object')->action_type ?? 0;
    }
}