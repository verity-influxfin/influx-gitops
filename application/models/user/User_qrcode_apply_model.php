...
class user_qrcode_apply_model extends MY_Model
{
    ...
    public $status_list = array(
        PROMOTE_REVIEW_STATUS_PENDING_TO_DRAW_UP => '待制定合約',
        PROMOTE_REVIEW_STATUS_SUCCESS => '審核成功',
        PROMOTE_REVIEW_STATUS_WITHDRAW => '審核失敗',
        PROMOTE_REVIEW_STATUS_PENDING_TO_REVIEW => '已送出審核'
    );
