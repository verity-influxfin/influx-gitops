...
class Labor_insurance_lib_file4 extends TestCase
{
	...
	private function readInputFile(){
		$outfile = dirname(__FILE__, 3) .  "/files/libraries/labor_insurance_lib/4-decoded.pdf";
	...
	{
		$extraFile = dirname(__FILE__, 3) .  "/files/libraries/labor_insurance_lib/4-extra.txt";
	...
	public function testProcessApplicantHavingGreatSalary()
	{
		...
		$this->labor_insurance_lib->processApplicantHavingGreatSalary(46000, $result);
