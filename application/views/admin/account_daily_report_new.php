        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">虛擬帳戶交易明細表
                        <a href="<?=admin_url('Account/daily_report_sheet?display=pdf&sdate='.$sdate.'&edate='.$edate) ?>" target="_blank" class="btn btn-primary float-right" >匯出PDF</a>
                        <a href="<?=admin_url('Account/daily_report_export?sdate='.$sdate.'&edate='.$edate.'&non_merge=False') ?>" target="_blank" class="btn btn-primary float-right" >匯出Excel</a>
                        <a href="<?=admin_url('Account/daily_report_export?sdate='.$sdate.'&edate='.$edate.'&non_merge=True') ?>" target="_blank" class="btn btn-primary float-right" >匯出Excel<br/><span style="font-size: 5px">(無合併儲存格)</span></a>
                    </h1>
            ...
            <script type="text/javascript">
                function showChang(){
                    var sdate 				= $('#sdate').val();
                    var edate 				= $('#edate').val();
                    top.location = './daily_report_sheet?sdate='+sdate+'&edate='+edate;
                }
            </script>
            <style>
                td{
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <table>
                                <tr>
                                    <td>指定區間：</td>
                                    <td><a href="<?=admin_url('Account/daily_report_sheet') ?>" target="_self" class="btn btn-default float-right btn-md" >本日</a></td>
                                ...
                                <tr>
                                    <td colspan="4">查詢範圍區間：<?=$sdate.' - '.$edate ?></td>
                                ...
                                <table class="table table-bordered table-hover" style="font-size:10px;text-align: left;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2">債權轉讓手續費</th>
                                            <th rowspan="2">轉換產品手續費</th>
                                            <th rowspan="2">違約金</th>
                                    ...
                                    ?>
                                        <tr <?=$count%2==0?"style='background-color: #DCDCDC;'":""; ?>>
                                            ...
                                            <td><?=isset($value["source_type"])?$value["source_type"]:"" ?></td>
