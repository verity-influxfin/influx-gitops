...
<body style="background: rgb(204,204,204); font-size: 14px;">
    <div class="container mt-2">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">新光</a>
            </li>
            <li class="nav-item">
                <a class="nav-link">凱基</a>
            </li>
            <li class="nav-item">
                    ...
                    <table class="table table-bordered border-dark">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompSetDate_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompCapital_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompIdustry_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <input class="input-width" type="button" onclick="edit_click(CompType_content)"
                                            value="Edit">
                                    </center>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompRegAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompRegAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompRegAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrOnboardDay_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrOnboardName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="ExPrOnboardDay_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="ExPrOnboardName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="ExPrOnboardDay2_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="ExPrOnboardName2_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrCityName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrAreaName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrRoadName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrRoadType_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrSec_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrLn_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrAly_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrNo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrNoExt_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrFloor_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrFloorExt_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrRoom_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="BizRegAddrOtherMemo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="LastPaidInCapitalDate_content" type="text"
                            ...
                            <tr>
                                <td class="title input-center bold-bottom-border bold-right-border" rowspan="47">B-企業資料表
                                </td>
                                <td class="bold-right-border">公司主要營業場所-郵遞區號</td>
                                <td colspan="3"><input id="CompMajorAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompMajorAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompMajorAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompTelAreaCode_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="is_biz_reg_addr_self_own" class="table-input"
                                        id="IsBizRegAddrSelfOwn_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="biz_reg_addr_owner" class="table-input"
                                        id="BizRegAddrOwner_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="is_biz_addr_eq_to_biz_reg_addr" class="table-input"
                                        id="IsBizAddrEqToBizRegAddr_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrCityName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrAreaName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrRoadName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrRoadType_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrSec_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrLn_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrAly_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrNo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrNoExt_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrFloor_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrFloorExt_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrRoom_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="RealBizAddrOtherMemo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="is_real_biz_addr_self_own" class="table-input"
                                        id="IsRealBizAddrSelfOwn_content" disabled>
                                        <option value="" selected></option>
                                        <option value="1">1:自有</option>
                                        <option value="0">0:非自有</option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="real_biz_addr_owner" class="table-input"
                                        id="RealBizAddrOwner_content" disabled>
                                        <option value="" selected></option>
                                        <option value="A">A:企業</option>
                                        <option value="B">B:負責人</option>
                                        <option value="C">C:負責人配偶</option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompMajorCityName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompMajorAreaName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompMajorSecName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompMajorSecNo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="comp_major_ownership" class="table-input"
                                        id="CompMajorOwnership_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="comp_major_setting" class="table-input"
                                        id="CompMajorSetting_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="biz_tax_file_way" class="table-input"
                                        id="BizTaxFileWay_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorAName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorAId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorBName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorBId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorCName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorCId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorDName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorDId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorEName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorEId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorFName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorFId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorGName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="DirectorGId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="EmployeeNum_content" type="text" class="table-input"
                                        disabled>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="ShareholderNum_content" type="text" class="table-input"
                                        disabled>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                                <td class="title input-center bold-bottom-border bold-right-border" rowspan="24">D-身份證
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrincipalId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrResAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrResAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrReslAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneResAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneResAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneReslAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <input class="input-width" type="button" onclick="edit_click(GuTwoName_content)"
                                            value="Edit">
                                    </center>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <input class="input-width" type="button" onclick="edit_click(GuTwoId_content)"
                                            value="Edit">
                                    </center>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoResAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoResAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoReslAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseBirth_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseResAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseResAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseReslAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                <td class="title input-center bold-bottom-border bold-right-border" rowspan="44">E-個人資料表
                                </td>
                                <td class="bold-right-border">負責人現居地址-郵遞區號</td>
                                <td colspan="3"><input id="PrCurAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrCurAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrCurlAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrTelAreaCode_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <input class="input-width" type="button" onclick="edit_click(PrTelNo_content)"
                                            value="Edit">
                                    </center>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <input class="input-width" type="button" onclick="edit_click(PrTelExt_content)"
                                            value="Edit">
                                    </center>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="is_prmarried" class="table-input" id="IsPrMarried_content"
                                        disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="is_prspousegu" class="table-input"
                                        id="IsPrSpouseGu_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <input class="input-width" type="button" onclick="edit_click(RealPr_content)"
                                            value="Edit">
                                    </center>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3"><input id="PrStartYear_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="pr_edu_level" class="table-input" id="PrEduLevel_content"
                                        disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="oth_real_pr_rel_with_pr" class="table-input"
                                        id="OthRealPrRelWithPr_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="OthRealPrName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="OthRealPrId_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="OthRealPrBirth_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="OthRealPrStartYear_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="OthRealPrTitle_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="OthRealPrSHRatio_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="gu_one_rel_with_pr" class="table-input"
                                        id="GuOneRelWithPr_content" disabled>
                                        <option value="" selected></option>
                                        <option value="A">A:配偶</option>
                                        <option value="B">B:血親</option>
                                        <option value="C">C:姻親</option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="gu_one_company" class="table-input"
                                        id="GuOneCompany_content" disabled>
                                        <option value="" selected></option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="gu_two_rel_with_pr" class="table-input"
                                        id="GuTwoRelWithPr_content" disabled>
                                        <option value="" selected></option>
                                        <option value="A">A:配偶</option>
                                        <option value="B">B:血親</option>
                                        <option value="C">C:姻親</option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><select name="gu_two_company" class="table-input"
                                        id="GuTwoCompany_content" disabled>
                                        <option value="" selected></option>
                                        <option value="A">A:公家機關</option>
                                        <option value="B">B:上市櫃公司</option>
                                        <option value="C">C:專業人士</option>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseCurAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseCurAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseCurlAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseTelAreaCode_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseTelNo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseTelExt_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseMobileNo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneCurAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneCurAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneCurlAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneTelAreaCode_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneTelExt_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuOneMobileNo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoCurAddrZip_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoCurAddrZipName_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoCurlAddress_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoTelAreaCode_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoTelExt_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="GuTwoMobileNo_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="AnnualIncomeYear1_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="AnnualIncome1_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="AnnualIncomeYear2_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="AnnualIncome2_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="AnnualIncomeYear3_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM1_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured1_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM2_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured2_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM3_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured3_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM4_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured4_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM5_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured5_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM6_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured6_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM7_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured7_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM8_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured8_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM9_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured9_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM10_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured10_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM11_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured11_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsuredYM12_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="NumOfInsured12_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                <td class="title input-center bold-bottom-border bold-right-border" rowspan="53">H-聯徵資料
                                </td>
                                <td class="bold-right-border">
                                    <div>企業聯徵查詢日期</div>
                                    <div style="color:red;">格式:YYYYMMDD</div>
                                </td>
                                <td colspan="3"><input id="CompJCICQueryDate_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="MidTermLnYM_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="MidTermLnBal_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="ShortTermLnYM_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="ShortTermLnBal_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompJCICDataDate_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="CompCreditScore_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrJCICQueryDate_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrCreditScore_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrJCICDataDate_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrBal_CashCard_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrBal_CreditCard_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrBal_ShortTermLn_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrBal_MidTermLn_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrBal_LongTermLn_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrBal_ShortTermGuar_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrBal_MidTermLnGuar_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="PrBal_LongTermLnGuar_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseJCICQueryDate_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="SpouseJCICDataDate_content" type="text" class="table-input"
                                        disabled>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input id="SpouseBal_ShortTermGuar_content" type="text" class="table-input"
                                        disabled>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input id="SpouseBal_MidTermLnGuar_content" type="text" class="table-input"
                                        disabled>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input id="SpouseBal_LongTermLnGuar_content" type="text" class="table-input"
                                        disabled>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input id="GuOneBal_LongTermLnGuar_content" type="text" class="table-input"
                                        disabled>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input id="GuTwoBal_LongTermLnGuar_content" type="text" class="table-input"
                                        disabled>
                                </td>
                                <td>
                                    <center>
                            ...
                            <tr>
                                <td class="title input-center bold-bottom-border bold-right-border" rowspan="8">I-勞保異動明細
                                </td>
                                <td class="bold-right-border">
