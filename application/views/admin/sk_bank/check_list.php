...
<body style="background: rgb(204,204,204); font-size: 14px;">
    <div class="container mt-2">
        ...
        <ul class="nav nav-tabs mt-2">
            <li class="nav-item pointer" onclick="changeTab('tab-1')">
                <a class="nav-link" id="nav-tab-1" aria-current="page" >新光</a>
            </li>
            <li class="nav-item pointer" onclick="changeTab('tab-2')">
                <a class="nav-link" id="nav-tab-2" >凱基</a>
            </li>
        </ul>
        <div id="page-tab-1" class="nav-page">
            <div class="page">
                    ...
                    <div>
                        <table class="table table-bordered border-dark">
                            <tbody>
								...
								<tr>
									<td class="bold-right-border">tab-1-custom</td>
        ...
        <div id="page-tab-2" class="nav-page">
            <div class="page">
                <div class="subpage api_data_page">
                    <h3 style="text-align: center;">百萬信保檢核表2</h3>
                    <div>
                        <table class="table table-bordered border-dark">
                            <tbody>
                                <tr>
								...
								<tr>
									<td class="bold-right-border">tab-2-custom</td>
									<td colspan="3"><input name="customTab2_content" type="text" class="table-input" disabled>
									</td>
								
									<td>
										<center>
											<input class="input-width" type="button" onclick="edit_click('customTab2')" value="Edit">
										</center>
									</td>
								</tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司行業別(主計處)</td>
                                    <td colspan="3"><input name="CompIdustry_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('CompIdustry_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('CompDuType_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司登記地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="CompRegAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="PrOnboardDay_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">前任負責人擔任公司起日-姓名</td>
                                    <td colspan="3"><input name="ExPrOnboardName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="ExPrOnboardDay2_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">前二任負責人擔任公司起日-姓名</td>
                                    <td colspan="3"><input name="ExPrOnboardName2_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="bold-right-border">公司主要營業場所-郵遞區號</td>
                                    <td colspan="3"><input name="CompMajorAddrZip_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司主要營業場所-郵遞區號名稱</td>
                                    <td colspan="3"><input name="CompMajorAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司主要營業場所-非郵遞地址資料</td>
                                    <td colspan="3"><input name="CompMajorAddress_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">主要營業場所建號-縣市名</td>
                                    <td colspan="3"><input name="CompMajorCityName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">主要營業場所建號-地區</td>
                                    <td colspan="3"><input name="CompMajorAreaName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">主要營業場所建號-段名</td>
                                    <td colspan="3"><input name="CompMajorSecName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">營業場所設定</td>
                                    <td colspan="3"><select name="CompMajorSetting_content" class="table-input" id="" disabled>
                                            <option value="" selected></option>
                                            <option value="A">A:無設定</option>
                                            <option value="B">B:第一順位新光</option>
                                            <option value="C">C:第一順位 非新光</option>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司董監事 A 統編</td>
                                    <td colspan="3"><input name="DirectorAId_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('DirectorAId_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司董監事 B 統編</td>
                                    <td colspan="3"><input name="DirectorBId_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('DirectorBId_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司董監事 C 統編</td>
                                    <td colspan="3"><input name="DirectorCId_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('DirectorCId_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司董監事 D 統編</td>
                                    <td colspan="3"><input name="DirectorDId_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('DirectorDId_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司董監事 E 統編</td>
                                    <td colspan="3"><input name="DirectorEId_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('DirectorEId_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司董監事 F 統編</td>
                                    <td colspan="3"><input name="DirectorFId_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('DirectorFId_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">公司董監事 G 統編</td>
                                    <td colspan="3"><input name="DirectorGId_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('DirectorGId_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人戶籍地址-郵遞區號</td>
                                    <td colspan="3"><input name="PrResAddrZip_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人戶籍地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="PrResAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="GuOneBirth_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('GuOneBirth_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bold-right-border">甲保證人戶籍地址-郵遞區號</td>
                                    <td colspan="3"><input name="GuOneResAddrZip_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人戶籍地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="GuOneResAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人戶籍地址-非郵遞地址資料</td>
                                    <td colspan="3"><input name="GuOneReslAddress_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人姓名</td>
                                    <td colspan="3"><input name="GuTwoName_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人統一編號</td>
                                    <td colspan="3"><input name="GuTwoId_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="GuTwoBirth_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('GuTwoBirth_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bold-right-border">乙保證人戶籍地址-郵遞區號</td>
                                    <td colspan="3"><input name="GuTwoResAddrZip_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人戶籍地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="GuTwoResAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人戶籍地址-非郵遞地址資料</td>
                                    <td colspan="3"><input name="GuTwoReslAddress_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="SpouseBirth_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('SpouseBirth_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bold-right-border">配偶戶籍地址-郵遞區號</td>
                                    <td colspan="3"><input name="SpouseResAddrZip_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶戶籍地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="SpouseResAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶戶籍地址-非郵遞地址資料</td>
                                    <td colspan="3"><input name="SpouseReslAddress_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="bold-right-border">負責人現居地址-郵遞區號</td>
                                    <td colspan="3"><input name="PrCurAddrZip_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人現居地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="PrCurAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人連絡電話-電話號碼</td>
                                    <td colspan="3"><input name="PrTelNo_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人連絡電話-分機碼</td>
                                    <td colspan="3"><input name="PrTelExt_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">保證人乙_與借戶負責人之關係</td>
                                    <td colspan="3"><select name="GuTwoRelWithPr_content" class="table-input" id="" disabled>
                                            <option value="" selected></option>
                                            <option value="A">A:配偶</option>
                                            <option value="B">B:血親</option>
                                            <option value="C">C:姻親</option>
                                ...
                                <tr>
                                    <td class="bold-right-border">保證人乙_任職公司</td>
                                    <td colspan="3"><select name="GuTwoCompany_content" class="table-input" id="" disabled>
                                            <option value="" selected></option>
                                            <option value="A">A:公家機關</option>
                                            <option value="B">B:上市櫃公司</option>
                                            <option value="C">C:專業人士</option>
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶現居地址-郵遞區號</td>
                                    <td colspan="3"><input name="SpouseCurAddrZip_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶現居地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="SpouseCurAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶現居地址-非郵遞地址資料</td>
                                    <td colspan="3"><input name="SpouseCurlAddress_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶連絡電話-區碼</td>
                                    <td colspan="3"><input name="SpouseTelAreaCode_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶連絡電話-電話號碼</td>
                                    <td colspan="3"><input name="SpouseTelNo_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('SpouseTelNo_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bold-right-border">配偶連絡電話-分機碼</td>
                                    <td colspan="3"><input name="SpouseTelExt_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人現居地址-郵遞區號</td>
                                    <td colspan="3"><input name="GuOneCurAddrZip_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人現居地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="GuOneCurAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人現居地址-非郵遞地址資料</td>
                                    <td colspan="3"><input name="GuOneCurlAddress_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人連絡電話-區碼</td>
                                    <td colspan="3"><input name="GuOneTelAreaCode_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人連絡電話-電話號碼</td>
                                    <td colspan="3"><input name="GuOneTelNo_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('GuOneTelNo_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bold-right-border">甲保證人連絡電話-分機碼</td>
                                    <td colspan="3"><input name="GuOneTelExt_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('GuOneTelExt_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人現居地址-郵遞區號</td>
                                    <td colspan="3"><input name="GuTwoCurAddrZip_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人現居地址-郵遞區號名稱</td>
                                    <td colspan="3"><input name="GuTwoCurAddrZipName_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人現居地址-非郵遞地址資料</td>
                                    <td colspan="3"><input name="GuTwoCurlAddress_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人連絡電話-區碼</td>
                                    <td colspan="3"><input name="GuTwoTelAreaCode_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人連絡電話-電話號碼</td>
                                    <td colspan="3"><input name="GuTwoTelNo_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('GuTwoTelNo_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bold-right-border">乙保證人連絡電話-分機碼</td>
                                    <td colspan="3"><input name="GuTwoTelExt_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('GuTwoTelExt_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="AnnualIncomeYear1_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="AnnualIncomeYear2_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="AnnualIncomeYear3_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="MidTermLnYM_content" type="text" class="table-input" disabled>
                                    </td>
        
                                    <td>
                                        <center>
                                            <input class="input-width" type="button" onclick="edit_click('MidTermLnYM_content')"
                                                value="Edit">
                                        </center>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="bold-right-border">公司中期放款餘額</td>
                                    <td colspan="3"><input name="MidTermLnBal_content" type="text" class="table-input" disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">企業信用評分</td>
                                    <td colspan="3"><input name="CompCreditScore_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="PrJCICQueryDate_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人銀行借款餘額(短放)</td>
                                    <td colspan="3"><input name="PrBal_ShortTermLn_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人銀行借款餘額(中放)</td>
                                    <td colspan="3"><input name="PrBal_MidTermLn_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人銀行借款餘額(長放)</td>
                                    <td colspan="3"><input name="PrBal_LongTermLn_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人銀行借款餘額(短擔)</td>
                                    <td colspan="3"><input name="PrBal_ShortTermGuar_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人銀行借款餘額(中擔)</td>
                                    <td colspan="3"><input name="PrBal_MidTermLnGuar_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">負責人銀行借款餘額(長擔)</td>
                                    <td colspan="3"><input name="PrBal_LongTermLnGuar_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><input name="SpouseJCICQueryDate_content" type="text" class="table-input"
                                            disabled>
                                    </td>
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶銀行借款餘額(現金卡)</td>
                                    <td colspan="3">
                                        <input name="SpouseBal_CashCard_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶銀行借款餘額(信用卡)</td>
                                    <td colspan="3">
                                        <input name="SpouseBal_CreditCard_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶銀行借款餘額(短放)</td>
                                    <td colspan="3">
                                        <input name="SpouseBal_ShortTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶銀行借款餘額(中放)</td>
                                    <td colspan="3">
                                        <input name="SpouseBal_MidTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶銀行借款餘額(長放)</td>
                                    <td colspan="3">
                                        <input name="SpouseBal_LongTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶銀行借款餘額(短擔)</td>
                                    <td colspan="3">
                                        <input name="SpouseBal_ShortTermGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶銀行借款餘額(中擔)</td>
                                    <td colspan="3">
                                        <input name="SpouseBal_MidTermLnGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">配偶銀行借款餘額(長擔)</td>
                                    <td colspan="3">
                                        <input name="SpouseBal_LongTermLnGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input name="GuOneJCICQueryDate_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人銀行借款餘額(現金卡)</td>
                                    <td colspan="3">
                                        <input name="GuOneBal_CashCard_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人銀行借款餘額(信用卡)</td>
                                    <td colspan="3">
                                        <input name="GuOneBal_CreditCard_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人銀行借款餘額(短放)</td>
                                    <td colspan="3">
                                        <input name="GuOneBal_ShortTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人銀行借款餘額(中放)</td>
                                    <td colspan="3">
                                        <input name="GuOneBal_MidTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人銀行借款餘額(長放)</td>
                                    <td colspan="3">
                                        <input name="GuOneBal_LongTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人銀行借款餘額(短擔)</td>
                                    <td colspan="3">
                                        <input name="GuOneBal_ShortTermGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人銀行借款餘額(中擔)</td>
                                    <td colspan="3">
                                        <input name="GuOneBal_MidTermLnGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">甲保證人銀行借款餘額(長擔)</td>
                                    <td colspan="3">
                                        <input name="GuOneBal_LongTermLnGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input name="GuTwoJCICQueryDate_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input name="GuTwoJCICDataDate_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人銀行借款餘額(現金卡)</td>
                                    <td colspan="3">
                                        <input name="GuTwoBal_CashCard_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人銀行借款餘額(信用卡)</td>
                                    <td colspan="3">
                                        <input name="GuTwoBal_CreditCard_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人銀行借款餘額(短放)</td>
                                    <td colspan="3">
                                        <input name="GuTwoBal_ShortTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人銀行借款餘額(中放)</td>
                                    <td colspan="3">
                                        <input name="GuTwoBal_MidTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人銀行借款餘額(長放)</td>
                                    <td colspan="3">
                                        <input name="GuTwoBal_LongTermLn_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人銀行借款餘額(短擔)</td>
                                    <td colspan="3">
                                        <input name="GuTwoBal_ShortTermGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人銀行借款餘額(中擔)</td>
                                    <td colspan="3">
                                        <input name="GuTwoBal_MidTermLnGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人銀行借款餘額(長擔)</td>
                                    <td colspan="3">
                                        <input name="GuTwoBal_LongTermLnGuar_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input name="GuTwoLaborQryDate_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
                                ...
                                <tr>
                                    <td class="bold-right-border">乙保證人-被保險人勞保異動查詢-最近期投保薪資</td>
                                    <td colspan="3">
                                        <input name="GuTwoLaborInsSalary_content" type="text" class="table-input" disabled>
                                    </td>
                                    <td>
                                        <center>
                                            <input class="input-width" type="button"
