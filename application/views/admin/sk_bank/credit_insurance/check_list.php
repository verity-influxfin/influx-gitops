...
<script>
    ...
    let data_type;
    // 下拉選單列表
    let select_array = ['CompType_content', 'BusinessType_content', 'compDuType_content', 'compType_content', 'bizRegAddrOwner_content', 'isBizAddrEqToBizRegAddr_content', 'BizTaxFileWay_content',
