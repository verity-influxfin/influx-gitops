                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label>頭款/訂金金額</label>
                                <p class="form-control-static"><?= $content['down_payment'] ?? '' ?></p>
                            </div>
                            <div class="form-group">
                                <label>備註</label>
                                <?php
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <table class="admin-edit">
                                            ...
                                            <tr>
                                                <td><label>合約金額</label></td>
                                                <td>
                                                    <input type="number" class="form-control"
                                                           name="admin_edit[contract_amount]"
                                                           value="<?= $admin_edit['contract_amount'] ?? '' ?>" <?= $input_disabled ?>>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><label>頭款/訂金金額</label></td>
                                                <td>
                                                    <input type="number" class="form-control"
                                                           name="admin_edit[down_payment]"
                                                           value="<?= $admin_edit['down_payment'] ?? '' ?>" <?= $input_disabled ?>>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><label>合約簽訂日</label></td>
                                                <td>
