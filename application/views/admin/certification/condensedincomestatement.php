                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>簡明損益表認證</label><br>
                                    <? isset($content['condensedincomestatement_image']) && !is_array($content['condensedincomestatement_image']) ? $content['condensedincomestatement_image'] = array($content['condensedincomestatement_image']) : '';
                                    foreach ($content['condensedincomestatement_image'] as $key => $value) { ?>
