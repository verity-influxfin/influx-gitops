                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>簡明資產負債表認證</label><br>
                                    <? isset($content['condensedbalancesheet_image']) && !is_array($content['condensedbalancesheet_image']) ? $content['condensedbalancesheet_image'] = array($content['condensedbalancesheet_image']) : '';
                                    foreach ($content['condensedbalancesheet_image'] as $key => $value) { ?>
