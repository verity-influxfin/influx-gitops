                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>公司章程</label><br>
                                    <? isset($content['charter_image']) && !is_array($content['charter_image']) ? $content['charter_image'] = array($content['charter_image']) : '';
                                    foreach ($content['charter_image'] as $key => $value) { ?>
