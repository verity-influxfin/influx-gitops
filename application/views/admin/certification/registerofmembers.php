                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>股東名冊</label><br>
                                    <? isset($content['registerofmembers_image']) && !is_array($content['registerofmembers_image']) ? $content['registerofmembers_image'] = array($content['registerofmembers_image']) : '';
                                    foreach ($content['registerofmembers_image'] as $key => $value) { ?>
