                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>進銷貨廠商明細表</label><br>
                                    <? isset($content['purchasesalesvendorlist_image']) && !is_array($content['purchasesalesvendorlist_image']) ? $content['purchasesalesvendorlist_image'] = array($content['purchasesalesvendorlist_image']) : '';
                                    foreach ($content['purchasesalesvendorlist_image'] as $key => $value) { ?>
