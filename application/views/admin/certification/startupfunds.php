                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>創業啟動金</label><br>
                                    <? isset($content['startupfunds_image']) && !is_array($content['startupfunds_image']) ? $content['startupfunds_image'] = array($content['startupfunds_image']) : '';
                                    foreach ($content['startupfunds_image'] as $key => $value) { ?>
