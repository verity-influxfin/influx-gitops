                                    ...
                                    <div class="form-group">
                                        <table class="admin-edit">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="admin_edit[receipt_number]"
                                                           value="<?= $admin_edit['receipt_number'] ?? '' ?>" <?= $input_disabled ?>>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><label>發票金額</label></td>
                                                <td>
                                                    <input type="number" class="form-control"
                                                           name="admin_edit[receipt_amount]"
                                                           value="<?= $admin_edit['receipt_amount'] ?? '' ?>" <?= $input_disabled ?>>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
