                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    ...
                                    <? isset($content['business_plan_image']) && !is_array($content['business_plan_image']) ? $content['business_plan_image'] = array($content['business_plan_image']) : '';
                                    foreach ($content['business_plan_image'] as $key => $value) { ?>
