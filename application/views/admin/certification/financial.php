                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label>薪資/打工收入</label>
                                <p class="form-control-static"><?=isset($content['income'])?$content['income']:""?></p>
                            </div>
                            <div class="form-group">
                                <label>零用錢收入</label>
                                <p class="form-control-static"><?=isset($content['incomeStudent'])?$content['incomeStudent']:""?></p>
                            </div>
                            <div class="form-group">
                                <label>獎學金收入</label>
                            ...
                            <div class="form-group">
                                <label>信用卡月繳</label>
                                <p class="form-control-static"><?=isset($content['credit_card_monthly_payment'])?$content['credit_card_monthly_payment']:""?></p>
                            </div>
                            <div class="form-group">
                                <label>民間借貸月付</label>
