                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>驗資基金證明</label><br>
                                    <? isset($content['verification_image']) && !is_array($content['verification_image']) ? $content['verification_image'] = array($content['verification_image']) : '';
                                    foreach ($content['verification_image'] as $key => $value) { ?>
