                        ...
                        <div class="panel-body">
                            <div class="row">
                                        ...
                                        <fieldset>
											...
											<div class="form-group" id="fail_div" style="display:none">
                                                ...
                                                <select id="fail" name="fail" class="form-control">
                                                    ...
                                                    <? foreach($certifications_msg[CERTIFICATION_CRIMINALRECORD] as $key => $value){ ?>
								...
								<div class="col-lg-6">
									...
									<fieldset disabled>
										<div class="form-group">
											<label for="disabledSelect">良民證照片</label><br>
											<a href="<?=isset($content['criminal_record_image'])?$content['criminal_record_image']:""?>" data-fancybox="images">
												<img src="<?=isset($content['criminal_record_image'])?$content['criminal_record_image']:""?>" style='width:30%;max-width:400px'>
											</a>
										</div>
									</fieldset>
								</div>
