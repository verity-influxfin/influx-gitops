                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>庫存車銷售檔</label><br>
                                    <? isset($content['car_sales_image']) && !is_array($content['car_sales_image']) ? $content['car_sales_image'] = array($content['car_sales_image']) : '';
                                    foreach ($content['car_sales_image'] as $key => $value) { ?>
