                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>親訪報告</label><br>
                                    <? isset($content['interview_image']) && !is_array($content['interview_image']) ? $content['interview_image'] = array($content['interview_image']) : '';
                                    foreach ($content['interview_image'] as $key => $value) { ?>
