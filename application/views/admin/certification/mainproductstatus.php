                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <fieldset disabled>
                                <div class="form-group">
                                    <label>主要商品銷售情況表</label><br>
                                    <? isset($content['mainproductstatus_image']) && !is_array($content['mainproductstatus_image']) ? $content['mainproductstatus_image'] = array($content['mainproductstatus_image']) : '';
                                    foreach ($content['mainproductstatus_image'] as $key => $value) { ?>
