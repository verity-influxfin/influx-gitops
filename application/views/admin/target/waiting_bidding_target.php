                                ...
                                <table class="table table-striped table-bordered table-hover" width="100%" <? if(!isset($input['target_id'])){ ?>id="dataTables-tables<? echo $typeKey; }?>">
									...
									?>
                                        <tr class="<?=$count%2==0?"odd":"even"; ?>">
											...
											<td><a class="btn btn-primary btn-info" href="<? echo $typeKey != 'judicialPersonFormBank' ? admin_url('creditmanagement/waiting_bidding_report?type=person&target_id='.$value->id.''):admin_url('target/waiting_reinspection'."?target_id=".$value->id)?>" target="_blank" >查看</a></td>
