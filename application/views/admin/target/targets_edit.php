                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" style="text-align:center;">
                                    ...
                                    <tr style="background-color:#f5f5f5;">
                                        <td colspan="8">
                                            <a class="fancyframe"
                                               href="<?= admin_url('User/display?id=' . $user_info->id) ?>">借款人資訊</a>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <? if ($data->status == 5 || $data->status == 10) { ?>
                                        <tr style="background-color:#f5f5f5;">
                                            <td colspan="8">
                                                <a class="fancyframe"
                                                   href="<?= admin_url('Target/transaction_display?id=' . $data->id) ?>">攤還表</a>
                                            </td>
                                        </tr>
                                        <tr style="background-color:#f5f5f5;">
                                            <td>期數</td>
                                        ...
                                        foreach ($investments as $key => $value) {
                                            ...
                                            <table class="table table-bordered table-hover" style="text-align:center;">
                                                ...
                                                <tr style="background-color:#f5f5f5;">
                                                    <td colspan="8">
                                                        <a class="fancyframe"
                                                           href="<?= admin_url('User/display?id=' . $value->user_info->id) ?>">出借人資訊：<?= isset($value->user_info->id) ? $value->user_info->id : ""; ?></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <p class="form-control-static">
                                                            <a class="fancyframe"
                                                               href="<?= admin_url('Passbook/display?virtual_account=' . $value->virtual_account->virtual_account) ?>"><?= $value->virtual_account->virtual_account ?></a>
                                                        </p>
                                                    </td>
                                                ...
                                                <? if (isset($investments_amortization_table[$value->id]) && $investments_amortization_table[$value->id]) { ?>
                                                    <tr style="background-color:#f5f5f5;">
                                                        <td colspan="8"><a class="fancyframe"
                                                                           href="<?= admin_url('Target/transaction_display?id=' . $data->id) ?>">攤還表</a>
                                                        </td>
                                                    </tr>
                                                    <tr style="background-color:#f5f5f5;">
