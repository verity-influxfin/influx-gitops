...
<body>
	<table style="width:100%;height:100%">
        ...
        <tr>
            <td colspan="6">
                <table>
                    <tr><td>日期： {send_time}</td></tr>
                    <tr><td>親愛的 {company_name} 您好:<br></td></tr>
                </table>
            </td>
        </tr>
        <tr style="height:100%;">
            <td colspan="2" style="border:2px #7fb4d5 solid;">
                <table>
                    ...
                    <tr><td>·會員編號：{company_user_id}</td></tr>
                    <tr><td>·公司名稱：{company_name}</td></tr>
                    <tr><td>·負責人：{responsible_name}</td></tr>
                    <tr><td>·統一編號：{tax}</td></tr>
                    <tr><td>·電話：{phone}</td></tr>
                    <tr>
                        <td></td>
                    </tr>
                </table>
            ...
            <td colspan="2"  style="border:2px #7fb4d5 solid;">
                <table>
                    ...
                    <tr><td>受款銀行帳戶資訊</td></tr>
                    <tr><td>  ·銀行：{bank_name}</td></tr>
                    <tr><td>  ·戶名：{bank_account_name}</td></tr>
                    <tr><td>  ·帳號：{virtual_account}</td></tr>
                    <tr>
                        <td></td>
                    </tr>
                </table>
