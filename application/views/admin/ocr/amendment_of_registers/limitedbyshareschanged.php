        ...
        <table class="table" border="1">
          <tbody>
            ...
            <tr>
              ...
              <td><input type="text" id="owner" class="save-this result-this"></td>
              <td>四、每股金額<span class="memo">（阿拉伯數字）</span></td>
              <td><input type="text" id="price_per_stock" class="input-right table-input save-this result-this" style="width: 93%;">元</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="4"><input id="paidInCapital" type="text" class="input-right save-this result-this" style="width: 97%;">元</td>
            </tr>
            <tr>
