...
/**
 * 傢俱家電合約或發票收據徵信項
 * Class Appliance_contract
 * @package Certification
 */
class Cert_appliance_contract_receipt extends Certification_base
{
    /**
     * @var int 該徵信項之代表編號
     */
    protected $certification_id = CERTIFICATION_APPLIANCE_CONTRACT_RECEIPT;
    ...
    {
        $retrieve_key = ['contract_amount', 'receipt_number', 'receipt_amount'];
