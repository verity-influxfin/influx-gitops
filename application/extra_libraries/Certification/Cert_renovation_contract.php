...
/**
 * 裝修合約徵信項
 * Class Renovation_contract
 * @package Certification
 */
class Cert_renovation_contract extends Certification_base
{
    /**
     * @var int 該徵信項之代表編號
     */
    protected $certification_id = CERTIFICATION_RENOVATION_CONTRACT;
