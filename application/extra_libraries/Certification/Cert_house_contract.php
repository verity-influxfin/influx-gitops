...
/**
 * 購屋合約徵信項
 * Class House_contract
 * @package Certification
 */
class Cert_house_contract extends Certification_base
{
    /**
     * @var int 該徵信項之代表編號
     */
    protected $certification_id = CERTIFICATION_HOUSE_CONTRACT;
    ...
    {
        $retrieve_key = ['address', 'contract_amount', 'down_payment'];
