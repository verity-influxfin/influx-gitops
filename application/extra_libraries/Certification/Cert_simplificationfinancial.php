...
/**
 * 財務收支
 * Class Simplificationfinancial
 * @package Certification
 */
class Cert_simplificationfinancial extends Certification_base
{
    /**
     * @var int 該徵信項之代表編號
     */
    protected $certification_id = CERTIFICATION_SIMPLIFICATIONFINANCIAL;
