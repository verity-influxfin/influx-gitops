...
/**
 * (名校貸)社交帳號徵信項
 * Class Social_intelligent
 * @package Certification
 */
class Cert_social_intelligent extends Certification_base
{
    /**
     * @var int 該徵信項之代表編號
     */
    protected $certification_id = CERTIFICATION_SOCIAL_INTELLIGENT;
    ...
    public function verify_data($content): bool
    {
        ...
        if (isset($this->certification['user_id']) && isset($content['instagram']['username']))
        {
            // IG爬蟲狀態
