...
class PersonalCreditSheet implements CreditSheetDefinition {
    ...
    function __construct($target)
    {
        ...
        $this->target = $target;
        $this->user = $this->CI->user_model->get_by(['id'=> isset($this->target->user_id) ? $this->target->user_id : 0]);
    }
     ...
     * @return int
     */
    protected function getCreditCategory() {
        $this->CI->load->model('loan/credit_model');
