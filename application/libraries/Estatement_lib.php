		...
		if($estatement_id){
			...
			if($estatement && $estatement->type=='estatement'){
				...
				if($user_info && $user_info->name && $user_info->email){
					...
					$title = '【普匯金融科技對帳單】';
					$content = '親愛的 '.$user_info->name.' 先生您好：<br> 　　茲寄送您'.$y.'年'.$m.'月綜合對帳單，請您核對。<br>若有疑問請洽Line@粉絲團客服，我們將竭誠為您服務。<br>普匯金融科技有限公司　敬上 <br><p style="color:red;font-size:14px;">＊附件綜合對帳單已設為加密信件，開啟密碼個人戶為身分證字號(英文字母請輸入大寫)，公司戶為統一編號。</p>';
