...
defined('TARGET_REPAYMENTED') OR define('TARGET_REPAYMENTED', 10);

defined('TARGET_ORDER_WAITING_QUOTE') OR define('TARGET_ORDER_WAITING_QUOTE', 20);
defined('TARGET_ORDER_WAITING_SIGNING') OR define('TARGET_ORDER_WAITING_SIGNING', 21);
defined('TARGET_ORDER_WAITING_VERIFY') OR define('TARGET_ORDER_WAITING_VERIFY', 22);
defined('TARGET_ORDER_WAITING_SHIP') OR define('TARGET_ORDER_WAITING_SHIP', 23);
defined('TARGET_ORDER_WAITING_VERIFY_TRANSFER') OR define('TARGET_ORDER_WAITING_VERIFY_TRANSFER', 24);
