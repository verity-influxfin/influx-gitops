...
defined('TARGET_WAITING_SIGNING') OR define('TARGET_WAITING_SIGNING', 1);
defined('TARGET_WAITING_VERIFY') OR define('TARGET_WAITING_VERIFY', 2);
defined('TARGET_WAITING_BIDDING') OR define('TARGET_WAITING_BIDDING', 3);
defined('TARGET_WAITING_LOAN') OR define('TARGET_WAITING_LOAN', 4);
defined('TARGET_REPAYMENTING') OR define('TARGET_REPAYMENTING', 5);
defined('TARGET_CANCEL') OR define('TARGET_CANCEL', 8);
defined('TARGET_FAIL') OR define('TARGET_FAIL', 9);
defined('TARGET_REPAYMENTED ') OR define('TARGET_REPAYMENTED ', 0);

defined('TARGET_ORDER_WAITING_QUOTE ') OR define('TARGET_ORDER_WAITING_QUOTE ', 0);
defined('TARGET_ORDER_WAITING_SIGNING ') OR define('TARGET_ORDER_WAITING_SIGNING ', 1);
defined('TARGET_ORDER_WAITING_VERIFY ') OR define('TARGET_ORDER_WAITING_VERIFY ', 2);
defined('TARGET_ORDER_WAITING_SHIP ') OR define('TARGET_ORDER_WAITING_SHIP ', 3);
defined('TARGET_ORDER_WAITING_VERIFY_TRANSFER ') OR define('TARGET_ORDER_WAITING_VERIFY_TRANSFER ', 4);
...
defined('TARGET_SUBSTATUS_SECOND_INSTANCE_TARGET ') OR define('TARGET_SUBSTATUS_SECOND_INSTANCE_TARGET ', 0);
