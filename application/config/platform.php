...
$config['certifications_msg'] = [
    1 => [
        '年齡不符'                 => '很抱歉，由於您的身份非平台服務範圍，我們無法提供服務給您，造成不便，敬請見諒！',
        '照片顛倒'                 => '您好，由於您拍攝的照片顛倒了，煩請您重新拍攝，感謝您的配合！',
        '照片不清晰'               => '您好，由於您拍攝的照片不清晰，煩請您重新拍攝，感謝您的配合！',
        '持證自拍不清晰'           => '您好，由於您的持證自拍證件不清晰，系統無法比對，煩請您重新拍攝，感謝您的配合！',
        '持證自拍證件遮臉'         => '您好，由於您持證自拍時，證件遮擋到臉部，請依照虛線範圍拍攝，感謝您的配合！',
        '持證自拍手指遮住證件資訊' => '您好，由於您持證自拍時，手指遮住證件資訊，導致系統無法比對，煩請您重新拍攝，感謝您的配合！',
    ],
    2 => [
        '學制不符'                 => '您好，由於您填寫的學制與證件不符，煩請重新填寫，感謝您的配合！',
        '學生證錯誤'               => '您好，由於您上傳的證件有誤，煩請您拍攝正確的證件，感謝您的配合！',
        'SIP無法登入'              => '您好，由於您填寫的SIP資訊有誤，煩請重新填寫，感謝您的配合！',
        '手填學校'                 => '很抱歉，由於您的身份非平台服務範圍，我們無法提供服務給您，造成不便，敬請見諒！',
    ],
    3 => [],
    4 => [
        'IG未達標準'               => '您好，由於您認證的IG非常用帳號，系統無法驗證，敬請見諒！',
    ],
    5 => [
        '聯絡人名字/關係不對'      => '您好，由於您填寫的緊急連絡人資訊有誤，煩請重新填寫，感謝您的配合！',
    ],
    6 => [],
    7 => [],
    8 => [
        '畢業證書錯誤'             => '您好，由於您上傳的證書有誤，煩請您拍攝正確的證書，感謝您的配合！',
        '手填學校'                 => '很抱歉，由於您的身份非平台服務範圍，我們無法提供服務給您，造成不便，敬請見諒！',
        '學制不符'                 => '您好，由於您填寫的學制與證書不符，煩請重新填寫，感謝您的配合！',
    ],
    9 => [
        '只拍電子聯徵一頁'         => '您好，請寄送完整版電子聯徵資料至credit@influxfin.com，感謝您的配合！',
        '聯徵沒過'                 => '很抱歉，由於您的聯徵資料與平台規範不符，我們無法提供服務給您，造成不便，敬請見諒！',
    ],
    11 => [
        '非本人'                   => '您好，系統無法判讀為本人，煩請您重新拍攝，感謝您的配合！',
        '光線或解析無法辨識'       => '您好，由於光線不足導致系統無法判讀，煩請您重新拍攝，感謝您的配合！',
    ]
];