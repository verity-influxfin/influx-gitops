...
$config['certifications'] = [
    ...
    1003 => ['id' => CERTIFICATION_INVESTIGATIONJUDICIAL, 'alias' => 'investigationjudicial', 'name' => '個人及公司聯徵報告', 'status' => 1, 'description' => '提供個人及公司聯徵報告', 'optional' => []],
    1004 => ['id' => CERTIFICATION_PASSBOOKCASHFLOW, 'alias' => 'passbookcashflow', 'name' => '近六個月往來存摺封面+內頁', 'status' => 1, 'description' => '提供近六個月往來存摺封面+內頁', 'optional' => []],
    ...
    1007 => ['id' => CERTIFICATION_GOVERNMENTAUTHORITIES, 'alias' => 'governmentauthorities', 'name' => '變更登記事項表/商業登記證明', 'status' => 1, 'description' => '提供變更登記事項表/商業登記證明', 'optional' => []],
    ...
    1017 => ['id' => CERTIFICATION_EMPLOYEEINSURANCELIST, 'alias' => 'employeeinsurancelist', 'name' => '員工投保單位人數資料表', 'status' => 1, 'description' => '提供員工投保單位人數資料表', 'optional' => []],
    1018 => ['id' => CERTIFICATION_PROFILEJUDICIAL, 'alias' => 'profilejudicial', 'name' => '公司基本資料', 'status' => 1, 'description' => '提供公司基本資料', 'optional' => []],
